const team = [
  ...
  },
  {
    name: "Maya Putri",
    role: "Mobile Lead",
    bio: "Ahli pengembangan mobile lintas platform dengan pengalaman 7+ tahun.",
    initials: "MP",
  ...
  },
  {
    ...
    bio: "Ahli database dan spesialis API yang menyukai kode bersih dan efisien.",
    initials: "RH",
  ...
  },
  {
    ...
    bio: "Praktisi agile yang memastikan pengiriman lancar dan pemangku kepuasan.",
    initials: "LK",
          ...
          {team.map((member, index) => (
            ...
            >
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto mb-6">
                <div
                  className={`w-full h-full rounded-2xl bg-gradient-to-br ${member.color} flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-300`}
                >
